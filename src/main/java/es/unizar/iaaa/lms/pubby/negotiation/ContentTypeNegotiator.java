 ...
 */
package es.unizar.iaaa.lms.pubby.negotiation;
...
public class ContentTypeNegotiator {
    ...
    /**
     * Sets an Accept header to be used as the default if a client does not send
     * an Accept header, or if the Accept header cannot be parsed. Defaults to
     * "* / *".
     */
    ...
    /**
     * Overrides the Accept header for certain user agents. This can be used to
     * implement special-case handling for user agents that send faulty Accept
     * headers.
     * 
     ...
     *            Only override the Accept header if the user agent sends this
     *            header; <tt>null</tt> means always override
    ...
    private class Negotiation {
        ...
        MediaRangeSpec negotiate() {
            ...
            while (it.hasNext()) {
                ...
                Iterator<MediaRangeSpec> aliasIt = variant.getAliases()
                    .iterator();
            ...
            return (bestMatchingVariant == null) ? bestDefaultVariant
                    : bestMatchingVariant;
        }
    ...
    private class AcceptHeaderOverride {
        ...
        AcceptHeaderOverride(Pattern userAgentPattern, String original,
                String replacement) {
