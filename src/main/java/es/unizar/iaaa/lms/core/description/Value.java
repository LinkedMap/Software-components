...
public class Value implements Comparable<Value> {
    ...
    public Value(ResourceDescription resourceDescription, RDFNode valueNode, Property predicate,
    ...
    public String getLabel() {
        ...
        if (result == null) {
            ...
            result = new ResourceDescription(node.asResource(), this.resourceDescription.model,
                this.resourceDescription.config).getLabel();
        }
        if (result == null)
            return null;
