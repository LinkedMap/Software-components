...
public class NotAcceptableException extends ServletException {
     ...
     */
    public NotAcceptableException(HttpServletRequest request) {
     ...
     */
    public NotAcceptableException(String urlPath, String method,
     ...
     */
    public NotAcceptableException(String methodName, Class<?> controllerClass) {
