...
public class NotHandledException extends ServletException {
     ...
     */
    public NotHandledException(HttpServletRequest request) {
     ...
     */
    public NotHandledException(String urlPath, String method,
     ...
     */
    public NotHandledException(String methodName, Class<?> controllerClass) {
