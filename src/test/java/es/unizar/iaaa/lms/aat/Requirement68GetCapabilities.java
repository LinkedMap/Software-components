...
@ContextConfiguration(classes = {
        ...
        WebConfig.class })
public class Requirement68GetCapabilities {
    MockMvc mockMvc;
    ...
    @Test
    public void representationUriGetCapabilities() throws Exception {
        ...
        when(request.getParameter("request")).thenReturn("GetCapabilities");
        ...
        assertEquals("http://localhost/api/servers/ign_base?version=1.3.0&service=WMS&request=GetCapabilities",
            lr.getCanonical());
    }
}
