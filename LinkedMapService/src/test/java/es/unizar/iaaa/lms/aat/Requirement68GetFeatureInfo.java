...
@ContextConfiguration(classes = {
        ...
        WebConfig.class })
public class Requirement68GetFeatureInfo {
    MockMvc mockMvc;
    ...
    public void representationUriGetMap() throws Exception {
        ...
        map.put("request", new String[] { "GetFeatureInfo" });
        ...
        map.put("query_layers", new String[] { "Municipio" });
        ...
        map.put("i", new String[] { "504" });
        map.put("j", new String[] { "290" });
        map.put("info_format", new String[] { "text/plain" });
        ...
        when(request.getParameter("request")).thenReturn("GetFeatureInfo");
        mockMvc
            .perform(
