...
public class GetMapMatcherTest {
    ...
    String EXPECTED_QUERY = "?version=1.3.0&"
            ...
            + "bgcolor=0xFFFFFF&exceptions=INIMAGE";
    ...
    public void setup() {
        ...
        config.setResourceTemplate("/id/maps/{beta}");
        config.setRepresentationTemplate("/doc/maps/{beta}");
        config.setPreferredExtension(".txt");
        config.setIdentifierKey("beta");

        matcher = new GetMapMatcher(config);
    ...
    public void checkMatchesWithQuery() {
        ...
        assertEquals("http://localhost/context/id/maps/da319d52-755d-3adb-b48b-6a2d04a63261",
        ...
        assertEquals("http://localhost/context/doc/maps/da319d52-755d-3adb-b48b-6a2d04a63261",
